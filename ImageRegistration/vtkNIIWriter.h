...
=========================================================================*/
// .NAME vtkNIIWriter - Write NIfTI-1 and NIfTI-2 medical image files
// .SECTION Description
...
#ifndef __vtkNIIWriter_h
#define __vtkNIIWriter_h
...
class VTK_EXPORT vtkNIIWriter : public vtkImageWriter
{
public:
  // Description:
  // Static method for construction.
  static vtkNIIWriter *New();
  vtkTypeMacro(vtkNIIWriter, vtkImageWriter);
  ...
  void SetNIFTIHeader(vtkNIIHeader *hdr);
  vtkNIIHeader *GetNIFTIHeader();
...
protected:
  ...
  vtkNIIHeader *NIFTIHeader;
  vtkNIIHeader *OwnHeader;
  int NIFTIVersion;

private:
  vtkNIIWriter(const vtkNIIWriter&);  // Not implemented.
  void operator=(const vtkNIIWriter&);  // Not implemented.
};

#endif // __vtkNIIWriter_h
