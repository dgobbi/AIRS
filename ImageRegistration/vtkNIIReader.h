...
=========================================================================*/
// .NAME vtkNIIReader - Read NIfTI-1 and NIfTI-2 medical image files
// .SECTION Description
...
//----------------------------------------------------------------------------
class VTK_EXPORT vtkNIIReader : public vtkImageReader2
{
public:
  // Description:
  // Static method for construction.
  static vtkNIIReader *New();
  vtkTypeMacro(vtkNIIReader, vtkImageReader2);
...
private:
  vtkNIIReader(const vtkNIIReader&);  // Not implemented.
