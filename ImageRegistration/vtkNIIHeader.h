...
=========================================================================*/
// .NAME vtkNIIHeader - Store NIfTI header information.
// .SECTION Description
...
// that will be stored in a file written by the vtkNIIWriter.  Note
...
// information.  Finally, note that the vtkNIIWriter will ignore the
...
// .SECTION See Also
// vtkNIIReader, vtkNIIWriter

#ifndef __vtkNIIHeader_h
#define __vtkNIIHeader_h
...
//----------------------------------------------------------------------------
class VTK_EXPORT vtkNIIHeader : public vtkObject
{
public:
  ...
  static vtkNIIHeader *New();
  vtkTypeMacro(vtkNIIHeader, vtkObject);
  ...
  // the vtkNIIWriter ignores this part of the header if a quaternion
  // has been set via vtkNIIWriter::SetQFormMatrix().
  ...
  // the vtkNIIWriter ignores this part of the header if a matrix
  // has been set via vtkNIIWriter::SetSFormMatrix().
...
private:
  vtkNIIHeader(const vtkNIIHeader&);  // Not implemented.
  void operator=(const vtkNIIHeader&);  // Not implemented.
};

#endif // __vtkNIIHeader_h
