...
=========================================================================*/
// .NAME vtkImageFastBlur - High-quality image resizing filter
// .SECTION Description
// vtkImageFastBlur will magnify or shrink an image with interpolation and
...
#ifndef __vtkImageFastBlur_h
#define __vtkImageFastBlur_h

#include "vtkThreadedImageAlgorithm.h"

class vtkAbstractImageInterpolator;

class VTK_EXPORT vtkImageFastBlur : public vtkThreadedImageAlgorithm
{
public:
  static vtkImageFastBlur *New();
  vtkTypeMacro(vtkImageFastBlur, vtkThreadedImageAlgorithm);
  ...
  // Description:
  // Turn interpolation on or off (by default, interpolation is off).
...
private:
  vtkImageFastBlur(const vtkImageFastBlur&);  // Not implemented.
  void operator=(const vtkImageFastBlur&);  // Not implemented.
};
