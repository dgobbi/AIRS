...
vtkStandardNewMacro(vtkNIIHeader);
...
//----------------------------------------------------------------------------
void vtkNIIHeader::SetHeader(const nifti_1_header *hdr)
{
...
//----------------------------------------------------------------------------
void vtkNIIHeader::GetHeader(nifti_1_header *hdr)
{
...
//----------------------------------------------------------------------------
void vtkNIIHeader::SetHeader(const nifti_2_header *hdr)
{
  memcpy(this->Magic, hdr->magic, sizeof(hdr->magic));
...
//----------------------------------------------------------------------------
void vtkNIIHeader::GetHeader(nifti_2_header *hdr)
{
...
//----------------------------------------------------------------------------
void vtkNIIHeader::DeepCopy(vtkNIIHeader *o)
{
  if (o)
    {
    nifti_2_header hdr;
...
//----------------------------------------------------------------------------
void vtkNIIHeader::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkNIIHeader::SetStringValue(char *x, const char *y, size_t n)
{
  if (y == 0)
    {
    y = "";
...
//----------------------------------------------------------------------------
void vtkNIIHeader::SetIntentName(const char *val)
{
  this->SetStringValue(this->IntentName, val, 16);
}

//----------------------------------------------------------------------------
void vtkNIIHeader::SetDescrip(const char *val)
{
  this->SetStringValue(this->Descrip, val, 80);
}

//----------------------------------------------------------------------------
void vtkNIIHeader::SetAuxFile(const char *val)
{
