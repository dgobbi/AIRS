...
struct vtkImageCorrelationRatioThreadStruct
{
  vtkImageCorrelationRatio *Algorithm;
...
VTK_THREAD_RETURN_TYPE vtkImageCorrelationRatioThreadedExecute(void *arg)
{
  vtkMultiThreader::ThreadInfo *ti =
    static_cast<vtkMultiThreader::ThreadInfo *>(arg);
  vtkImageCorrelationRatioThreadStruct *ts =
    static_cast<vtkImageCorrelationRatioThreadStruct *>(ti->UserData);
  ...
  vtkInformationVector* outputVector)
{
  ...
  this->Threader->SetSingleMethod(vtkImageCorrelationRatioThreadedExecute, &ts);
